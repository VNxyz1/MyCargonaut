                    ...
                    <Col sm={4} id="prof-sidebar">
                        <div>
                            ...
                            <div className="prof-side-btn-wrapper">
                                ...
                                {userData && (
                                    <>
        <span onClick={() => userData && userData.phoneNumber && userData.profilePicture && openCreateTripModal()} className={userData && userData.phoneNumber && userData.profilePicture ? "" : "disabled"}>
            <i className="icon-plus"></i> Fahrt anlegen
        </span>
                                        <span onClick={() => userData && userData.phoneNumber && userData.profilePicture && openCreateCargoModal()} className={userData && userData.phoneNumber && userData.profilePicture ? "" : "disabled"}>
            <i className="icon-plus"></i> Transport anlegen
        </span>
                                        <span onClick={() => userData && userData.phoneNumber && userData.profilePicture && openVehicleAddModal()} className={userData && userData.phoneNumber && userData.profilePicture ? "" : "disabled"}>
            <i className="icon-plus"></i> Fahrzeug hinzufügen
        </span>
                                        <span onClick={() => userData && userData.phoneNumber && userData.profilePicture && openRatingModal()} className={userData && userData.phoneNumber && userData.profilePicture ? "" : "disabled"}>
            <i className="icon-plus"></i> Fahrt bewerten
        </span>
                                    </>
                                )}
