...
/* Profile picture upload */
    @Put('upload')
    @UseGuards(IsLoggedInGuard)
    @ApiOperation({summary: 'Upload/Replace profile picture and update path in user'})
    @ApiResponse({ type: OKResponseWithMessageDTO })
    @UseInterceptors(
    ...
    @ApiResponse({description: 'Profile picture retrieved successfully', type: 'image/png'})
